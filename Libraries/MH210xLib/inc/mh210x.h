...
/**
 * @brief mh210x Standard Peripheral Library version number
   */
#define __mh210X_STDPERIPH_VERSION_MAIN   (0x03) /*!< [31:24] main version */                                  
#define __mh210X_STDPERIPH_VERSION_SUB1   (0x05) /*!< [23:16] sub1 version */
#define __mh210X_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __mh210X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __mh210X_STDPERIPH_VERSION       ( (__mh210X_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__mh210X_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__mh210X_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__mh210X_STDPERIPH_VERSION_RC))
 ...
 */
#define __MPU_PRESENT             1 /*!< mh devices provide an MPU */
#define __NVIC_PRIO_BITS          3 /*!< mh uses 3 Bits for the Priority Levels    */
#define __Vendor_SysTickConfig    0 /*!< Set to 1 if different SysTick Config is used */

/**
 * @brief mh210x Interrupt Number Definition, according to the selected device 
...
/*!< mh210x Standard Peripheral Library old types (maintained for legacy purpose) */
typedef int32_t  s32;
typedef int16_t s16;
typedef int8_t  s8;
...
/*!< mh210x Standard Peripheral Library old definitions (maintained for legacy purpose) */
